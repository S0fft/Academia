...
while True:
    ...
    error_simpson = abs(integral_simpson - integral_right_triangle) / 15
...
print("Інтегральний метод парабол (формула Сімпсона):", integral_simpson)
print("Кількість розбиття:", n)
print("Похибка методу правих прямих трикутників:", error_right_triangle)
print("Похибка методу параболу (формула Сімпсона):", error_simpson)
